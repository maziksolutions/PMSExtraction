      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex w-[58%] shrink-0 flex-col gap-3 overflow-hidden border-r border-slate-800 p-4">
          ...
          {displayImageUrl ? (
            ...
            <div className="flex flex-1 flex-col items-center justify-center rounded-xl border border-dashed border-sky-900/50 bg-slate-900/40 p-8 text-center">
              <div className="relative mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-sky-950/80 border border-sky-800/60">
              ...
              <div className="mt-4 w-60 max-w-full overflow-hidden rounded-full bg-slate-800/90 p-0.5 border border-slate-700/60 shadow-inner">
              ...
              <button
                type="button"
                onClick={cancelPageLoading}
                className="mt-4 flex items-center gap-1.5 rounded-lg border border-slate-700 bg-slate-800/90 px-3.5 py-1.5 text-xs font-medium text-slate-300 hover:bg-red-950/60 hover:border-red-800 hover:text-red-300 transition-colors"
              >
                <X className="h-3.5 w-3.5" />
                Cancel Loading
              </button>
